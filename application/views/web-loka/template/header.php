                                    ...
                                    <ul class="hm">
                                        <li class="hm-minicart">
                                            <div class="hm-minicart-trigger">
                                                ...
                                                <span class="item-text"><i class="fa fa-user"></i> Login</span>
                                            </div>
                                            <span></span>
                                            <div class="minicart">
                        ...
                        <div class="row">
                            <div class="col-lg-12 ml-40">
                               ...
                               <div class="hb-menu">
                                   <nav>
                                       <ul>
                                           <li class="dropdown-holder"><a href="<?php echo base_url();?>home">Home</a>
                                               <ul class="hb-dropdown">
                                                   <li><a href="<?php echo base_url();?>home/profile_perusahaan">Profile Perusahaan</a></li>
                                                   <li><a href="<?php echo base_url();?>home/visi_misi">Visi dan Misi</a></li>
                                                   <li><a href="<?php echo base_url();?>home/struktur_organisasi">Struktur Organisasi</a></li>
                                                  <li><a href="<?php echo base_url();?>home/investor">Investor</a></li>
                                               </ul>
                                           </li>
                                           <li class="megamenu-holder"><a href="<?php echo base_url();?>shop">Shop</a>
                                               <ul class="megamenu hb-megamenu">
                                                   ...
                                                   <li><a href="#">Single Product Style</a>
                                                       <ul>
