                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="li-blog-banner">
                                                    <a href="blog-details-left-sidebar.html"><img class="img-full" src="<?php echo base_url('/asset/web-loka/');?>images/blog-banner/2.jpg" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="li-blog-gallery-slider slick-dot-style">
                                                    <div class="li-blog-banner">
                                                        <a href="blog-details-left-sidebar.html"><img class="img-full" src="<?php echo base_url('/asset/web-loka/');?>images/blog-banner/1.jpg" alt=""></a>
                                                    </div>
                                                    <div class="li-blog-banner">
                                                        <a href="blog-details-left-sidebar.html"><img class="img-full" src="<?php echo base_url('/asset/web-loka/');?>images/blog-banner/2.jpg" alt=""></a>
                                                    </div>
                                                    <div class="li-blog-banner">
                                                        <a href="blog-details-left-sidebar.html"><img class="img-full" src="<?php echo base_url('/asset/web-loka/');?>images/blog-banner/3.jpg" alt=""></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="li-blog-single-item pb-30">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="li-blog-banner">
                                                    <a href="blog-details-left-sidebar.html"><img class="img-full" src="<?php echo base_url('/asset/web-loka/');?>images/blog-banner/5.jpg" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="li-blog-content">
                                ...
                                <div class="col-lg-6">
                                    <div class="li-blog-single-item mb-30">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="li-blog-banner">
                                                    <a href="blog-details-left-sidebar.html"><img class="img-full" src="<?php echo base_url('/asset/web-loka/');?>images/blog-banner/6.jpg" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="li-blog-content">
